    ...
    <div className="w-full h-screen flex py-[5%] px-[10%]">
      <div className="w-full h-full m-auto rounded-lg flex justify-between space-x-10 p-5 border border-gray-200 shadow-xl">
        <div className="w-[45%] lg:flex items-center justify-center hidden">
          <img src="thisartwork.jpg" className="w-full h-full object-cover rounded-lg hover:scale-102 transition duration-300" />
        </div>
        <form className="px-2 w-[45%] flex flex-col flex-grow overflow-auto">
          ...
          <div className="mb-5">
            ...
            <button
            type="submit"
            className="px-4 py-1 bg-blue-700 text-white rounded-lg hover:bg-blue-800 mt-3 w-[150px] hover:cursor-pointer transition-all duration-300 transform hover:scale-105"
            >
              <span className="transition-all duration-300 transform hover:scale-105">Sign in</span>
            </button>
